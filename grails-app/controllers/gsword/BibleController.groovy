...
//  private static final URL scheduletxt = BibleController.class.getResource("/res/daily.txt");
  def scheduletxt= getClass().getResource("/daily.txt")
  ...
  //private static final URL xslurl= BibleController.class.getResource("/iBD.xsl");
  ...
  def x1= getClass().getResource("/iBD.xsl")
	println ("x1......"+x1)
//  def xslurl= getClass().getResource("/res/ibd.xsl");
  def xslurl= getClass().getResource("/iBD.xsl")
